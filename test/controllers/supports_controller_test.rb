...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { Email: @support.Email, Message: @support.Message, Name: @support.Name, Subject: @support.Subject } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { Email: @support.Email, Message: @support.Message, Name: @support.Name, Subject: @support.Subject } }
