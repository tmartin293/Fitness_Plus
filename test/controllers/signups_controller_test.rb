...
class SignupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post signups_url, params: { signup: { Name: @signup.Name, email: @signup.email, password: @signup.password } }
    end
  ...
  test "should update signup" do
    patch signup_url(@signup), params: { signup: { Name: @signup.Name, email: @signup.email, password: @signup.password } }
