...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { age: @user_info.age, height: @user_info.height, skill_level: @user_info.skill_level, weight: @user_info.weight } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { age: @user_info.age, height: @user_info.height, skill_level: @user_info.skill_level, weight: @user_info.weight } }
